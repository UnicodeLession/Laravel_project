            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    @error('name') is-invalid @enderror"
                           value="{{ old('name') ?? $teacher->name }}" autofocus placeholder="Tiêu Đề...">
                    @error('name')
            ...
            <div class="col-6">
                ...
                <div class="mb-3 input-group">
                    <input id="slug" name="slug" type="text"
                           class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug') ?? $teacher->slug }}"
                    ...
                    <div class="row align-items-end ">
                        <div class="col-7 input-group">
                            <input id="image" type="text" name="image"
                                   ...
                                   placeholder="Ảnh đại diện..."  value="{{ old('image') ?? $teacher->image }}">
